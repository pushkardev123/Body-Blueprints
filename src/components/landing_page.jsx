...
const Home = () => {
    ...
    const [isFirstRender, Render] = useState(true);
    ...
    // useEffect(() => {
    //     if (selectedMuscle && exerciseRef.current) {
    ...
    return (
        <>
            <div className="front text-white flex flex-row justify-between h-[80vh] sm:mx-auto  w-screen">
                <svg
                    id='front-anatomy'
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    className="w-screen h-[80vh] sm:mx-auto object-fit menor"
                ...
                >
                    ...
                    <g
                        ...
                        onClick={handleClick}
                        fill="black"
                        className="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100 hover"
                    >
                    ...
                    <g
                        ...
                        id="hands"
                        fill="black"
                        className="bodymap hover text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                    >
                    ...
                    <g
                        onClick={handleClick} id="shoulders" className="hidden">
                        <ellipse
                            id="hover-2"
                            cx="441.13"
                            cy="261.13"
